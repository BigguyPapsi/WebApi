...
export default {
 ...
 mounted(){
  axios.get('https://script.google.com/macros/s/AKfycbzz-j83MrZomTfLaP-Sb0CsTdFcHGR-qTdPLb4L_GmnSrHrCbM0HUo1qS8G3B6YEiTrUQ/exec?action=getData').then((res) => {this.item=res.data})
 }
}
</script>
...
<button type="button" class="minecraft_btn" style=" margin-top: 1%;"> <a style="text-decoration: none; color: white; font-family: 'Minecraft';" :href="item[0].link" > Click here!</a> </button>
...
@font-face {
    ...
    src: url('../assets/font/Minecraft.woff') format('woff2'),
